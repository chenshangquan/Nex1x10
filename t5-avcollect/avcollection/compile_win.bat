...
if exist ".\..\..\10-common\version\compileInfo\%compileinfo_dll_d_name%" (
    del /F /Q ".\..\..\10-common\version\compileInfo\%compileinfo_dll_d_name%"
)

devenv AVCollection.vcxproj /Rebuild "Debug" /Project AVCollection.vcxproj /ProjectConfig "Debug|Win32" /Out "%dir_10common%\version\compileInfo\%compileinfo_dll_d_name%"
