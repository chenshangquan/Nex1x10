 ...
 * @date    20140707
 ---------------------------------------------------------------------------*/
class NVCBB_API CAbstractIns : public CInstance
{
...
protected:
	...
	virtual BOOL32 MessageProc(nvmsg::CNvMsg *pcNvMsg, u32 dwSrcId, u32 dwSrcNode);
	virtual BOOL32 DaemonMessageProc(nvmsg::CNvMsg *pcNvMsg, CApp *pcApp, u32 dwSrcId, u32 dwSrcNode);
...
------------------------------------------------------------------------*/
NVCBB_API BOOL32 CreateApp(CApp *pcApp, const s8 *pszName, u16 wAppId, u8 byPri = 80, u16 wQueueSize = 80, u32 dwStackSize = 200<<10, u32 dwParam = 0);
...
* @return  BOOL32 TRUE:成功处理， FALSE:处理失败
------------------------------------------------------------------------*/
NVCBB_API BOOL32 QuitApp(CApp *pcApp);
