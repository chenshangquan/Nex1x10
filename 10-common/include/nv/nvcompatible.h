/**===========================================================================
* @file    nvh323stackcompatible.h
* @brief   这个文件全部是用来兼容5.0之前的老平台定义定义的非标消息， 和非标结构体
* @author  wuhu
* @date    
* @version  
...
#ifndef _NV_H323STACKCOMPATIBLE_H
#define _NV_H323STACKCOMPATIBLE_H
...
//终端会议状态
#define     NV_STATUS_AUDIENCE               0   //观众  
#define     NV_STATUS_CHAIRMAN               1   //主席
#define     NV_STATUS_SPEAKER                2   //发言人
...
//会议创建方式
#define		CONF_CREATE_NV                  201 //会议由终端创建
...
#define     CONF_RELEASEMODE_NONV            1  //无终端时自动结束
...
//自主画面合成类型定义（新增定义）
#define    CONF_TYPE_NONBROADCAST			    0	//非广播
#define    CONF_TYPE_BROADCAST			    1	//广播
#define    CONF_TYPE_SELFRECEIVE			    2	//自己看
...
#define		CONF_DUALMODE_EACHNVATWILL		 1	//任意终端都能发起
...
#define		VMP_STYLE_THREE                  4   //三画面  一上两下
#define		VMP_STYLE_FOUR                   5   //四画面  等大，2行2列
#define		VMP_STYLE_SIX                    6   //六画面  一大五小
#define		VMP_STYLE_EIGHT                  7   //八画面  一大七小
#define		VMP_STYLE_NINE                   8   //九画面  等大，3行3列
#define		VMP_STYLE_TEN                    9   //十画面  2大8小
#define		VMP_STYLE_THIRTEEN               10  //十三画面 1大12小 
#define		VMP_STYLE_SIXTEEN                11  //十六画面 16平分
#define		VMP_STYLE_SPECFOUR               12  //特殊四画面 1大左，3右
#define		VMP_STYLE_SEVEN                  13  //七画面   3大4小
#define		VMP_STYLE_TWENTY				 14  //二十画面 20平均
#define		VMP_STYLE_TEN_H  				 15  //水平分割的十画面(上2下8)
#define     VMP_STYLE_SIX_L2UP_S4DOWN        16  //特殊六画面(上2下4)  
#define     VMP_STYLE_FOURTEEN               17  //十四画面    老终端代码搜了下没用到
#define     VMP_STYLE_TEN_M                  18  //十画面(上4中2下4)
#define     VMP_STYLE_THIRTEEN_M             19  //十三画面(一大在中间)
#define     VMP_STYLE_FIFTEEN                20  //十五画面   老终端代码搜了下没用到
...
#define     NV_BOARD_UNKNOW                 255
#define     NV_BOARD_WIN                    0

// KDV系列终端：1-49
#define     NV_BOARD_8010                   1
#define     NV_BOARD_8010A                  2
#define     NV_BOARD_8018                   3
#define     NV_BOARD_INV                    4
#define     NV_BOARD_8010C                  5

#define     NV_BOARD_8010A_2                7
#define     NV_BOARD_8010A_4                8
#define     NV_BOARD_8010A_8                9

#define     NV_BOARD_7210                   10
#define     NV_BOARD_7610                   11
#define     NV_BOARD_7810                   12
#define     NV_BOARD_7910                   13

#define		NV_BOARD_5610_KDV				14
#define		NV_BOARD_6610_KDV				15

//KDV-二代高清系列
// #define     NV_BOARD_7820_A                 18
// #define     NV_BOARD_7820_B                 19
// #define     NV_BOARD_7920_A                 20
// #define     NV_BOARD_7920_B                 21

#define     NV_BOARD_7820_A_NOSDI           18
#define     NV_BOARD_7820_B_NOSDI           19
#define     NV_BOARD_7920_A_NOSDI           20
#define     NV_BOARD_7920_B_NOSDI           21

#define     NV_BOARD_7820_A_SDIINOUT        22
#define     NV_BOARD_7820_B_SDIINOUT        23
#define     NV_BOARD_7920_A_SDIINOUT        24
#define     NV_BOARD_7920_B_SDIINOUT        25
#define     NV_BOARD_7820_A_SDIININ         26
#define     NV_BOARD_7820_B_SDIININ         27
#define     NV_BOARD_7920_A_SDIININ         28
#define     NV_BOARD_7920_B_SDIININ         29

#define     NV_BOARD_7920_L        30

//KDV-三代高清系列
#define     NV_BOARD_H600_LB				31
#define     NV_BOARD_H600_B					32
#define     NV_BOARD_H600_C					33
#define     NV_BOARD_H700_A					34
#define     NV_BOARD_H700_B					35
#define     NV_BOARD_H700_C					36
#define     NV_BOARD_H900_A_NOSDI			37
#define     NV_BOARD_H900_A_SDIINOUT        38
#define     NV_BOARD_H900_A_SDIININ         39
#define     NV_BOARD_H900_B_NOSDI			40
#define     NV_BOARD_H900_B_SDIINOUT        41
#define     NV_BOARD_H900_B_SDIININ         42
#define     NV_BOARD_H900_C_NOSDI			43
#define     NV_BOARD_H900_C_SDIINOUT        44
#define     NV_BOARD_H900_C_SDIININ         45
#define     NV_BOARD_H600_LC				46
#define     NV_BOARD_H800_A					47
#define     NV_BOARD_H800_B					48
#define     NV_BOARD_H800_C					49

//KDV-T3系列
#define     NV_BOARD_7620_A                 16
#define     NV_BOARD_7620_B                 17

#define     NV_BOARD_KDVx_END               50
// TS系列：在 51-99 范围中
#define     NV_BOARD_6610                   51
#define     NV_BOARD_6610E                  52
#define     NV_BOARD_6210                   53
#define     NV_BOARD_5210                   54
#define     NV_BOARD_3210                   55 
#define     NV_BOARD_V5                     56

#define     NV_BOARD_3610                   57
#define     NV_BOARD_5610                   58
#define     NV_BOARD_6210E                  59

#define     NV_BOARD_TSx_END                100

// 为保证兼容 V系列和TS系列并列定义
// V系列：在 101-150 范围中
// #define     NV_BOARD_V5                     101

#define     NV_BOARD_Vx_END                 150
...
//mcs显示终端视频源别名功能
#define    NV_MAXNUM_VIDSOURCE        (u8)(10)            //最大视频源数
#define    NV_MAX_PORTNAME_LEN        (u8)(16)            // 视频矩阵端口名最大长度           
...
enum Mcu2NvNtfMsgType
{
    emNoneNtf           = 0,
    emBePolledNextNtf   = 1           //即将被轮询到 通知
};

enum emNvSpeakerStatus
{
    emBgn               = 0,
...
// 终端ID号定义
//////////////////////////////////////////////////////////////////////////
typedef struct tagNvLabel
{
	// 设置和获取终端ID号
	void SetNvLabel( u8 byMcuNum, u8 byNvNum )
	{
		byMcuNo = byMcuNum;
		byNvNo = byNvNum;
	}
	...
	u8 GetNvNo( void ) { return byNvNo; }
	tagNvLabel() : byMcuNo( 0 ), byNvNo( 0 ) {}
private :
	u8 byMcuNo;
	u8 byNvNo;
}PACKED TNVLABEL,*PTNVLABEL;
...
#define ROLLMSG_MSGHEAD_SRCNV_OFFSET		(ROLLMSG_MSGHEAD_ROLLRATE_OFFSET + ROLLMSG_MSGHEAD_ROLLRATE_LEN)
#define ROLLMSG_MSGHEAD_SRCNV_LEN			2
#define ROLLMSG_MSGHEAD_DSTNVNUM_OFFSET		(ROLLMSG_MSGHEAD_SRCNV_OFFSET + ROLLMSG_MSGHEAD_SRCNV_LEN)
#define ROLLMSG_MSGHEAD_DSTNVNUM_LEN		2
#define ROLLMSG_MSGHEAD_ROLLMSGLEN_OFFSET	(ROLLMSG_MSGHEAD_DSTNVNUM_OFFSET + ROLLMSG_MSGHEAD_DSTNVNUM_LEN)
...
//逻辑通道消息, 所有非标的，用于兼容的消息
enum H245NonStandCtrlMsgType
{
	...
	h_ctrl_confInfoRsp,						//回答会议信息			MC->ter, 透明转发给NVC
    ...
    h_ctrl_matrixCfgCmd,                    //为兼容3.6终端保留, 矩阵配置命令			MC->ter,	1Byte(NV_AUDIO/NV_VIDEO/NV_AV) + _TMATRIXPORT(Output) + _TMATRIXPORT(Input)
	...
	h_ctrl_defaultmatrixInfoCmd,            //为兼容3.6终端保留, 矩阵默认配置信息命令  MC->ter,1Byte(NV_AUDIO/NV_VIDEO/NV_AV)
	h_ctrl_matrixInfoInd,                   //为兼容3.6终端保留, 当前矩阵配置信息指示	ter->MC,1Byte(NV_AUDIO/NV_VIDEO/NV_AV) + _TMATRIXINFO(如果是AV则为数组,A+V)
    ...
    h_ctrl_matrixInfoReq,                   //为兼容3.6终端保留, 请求矩阵当前配置信息	MC->ter,1Byte(NV_AUDIO/NV_VIDEO/NV_AV)
	h_ctrl_matrixSchemeReq,                 //为兼容3.6终端保留, 所有矩阵方案请求 MC->ter,1Byte(NV_AUDIO/NV_VIDEO/NV_AV)
    ...
    // mcu
    h_ctrl_McuMcuAddNvReq,					//MCU邀请下级mcu上的终端       Mcu->Mcu  TAddNvInfo数组
    h_ctrl_McuMcuAddNvRsp,                  //MCU邀请下级mcu上的终端应答   Mcu->Mcu  1BYTE (granted/denied)
    
    h_ctrl_McuMcuCallNvCmd,                 //MCU呼叫下级mcu上的终端       Mcu->Mcu   TNv
    h_ctrl_McuMcuCallAlertingInd,           //正在呼叫通报                 Mcu->Mcu   TNv
    h_ctrl_McuMcuNvJoinedInd,               //新终端加入通报               Mcu->Mcu   TNv
    
    h_ctrl_McuMcuDropNvCmd,                 //mcu挂断下级mcu上的终端       Mcu->Mcu   TNv
    h_ctrl_McuMcuDelNvCmd,                  //mcu删除下级mcu上的终端       Mcu->Mcu   TNv
    h_ctrl_McuMcuNvDisconnectedInd,         //终端挂断通知                 Mcu->Mcu   TNv
    h_ctrl_McuMcuNvDeletedInd,              //终端离会通告                 Mcu->Mcu   TNv
    
    h_ctrl_McuMcuGetNvListReq,              //Mcu之间请求对方终端列表      Mcu->Mcu   Null
    h_ctrl_McuMcuGetNvListRsp,              //Mcu之间请求对方终端列表应答  Mcu->Mcu   TNv+TnvAlias数组
    h_ctrl_McuMcuConfNvInfoInd,             //终端信息通知                 Mcu->Mcu   TConfNvInfo + TNvEx数组
    
    h_ctrl_McMcuSetReverseChannelCmd,       //指定回传通道,消息体TNv       Mcu->Mcu   Tnv
    h_ctrl_McuMcuNewReverseChannelInd,      //新回传通道通知               Mcu->Mcu   Tnv
    h_ctrl_McuMcuAudioInfoReq,              //请求音频信息                 Mcu->Mcu   Null
    h_ctrl_McuMcuAudioInfoRsp,              //请求音频信息响应             Mcu->Mcu   TNv数组
    h_ctrl_McuMcuVideoInfoReq,              //请求视频信息                 Mcu->Mcu   Null
    h_ctrl_McuMcuVideoInfoRsp,              //请求视频信息响应             Mcu->Mcu   TNv数组
    
    h_ctrl_McuMcuConfNvStatusInd,           //终端状态上报                 Mcu->Mcu   TMcu+TNvStatus数组
    h_ctrl_McuMcuFeccCmd,                   //摄像头远遥                   Mcu->Mcu   TNv + 1byte：远遥操作类型 + 1 byte: 远遥参数
    h_ctrl_McuMcuSendMsgInd,                //终端短消息通知               Mcu->Mcu   消息体：TNv(终端号为0广播到所有终端)+TROLLMSG(有效长度)
    
    h_ctrl_McuMcuNewSpeakerInd,             //上级改变发言人通知           Mcu->Mcu   消息体：TNv+1byte(媒体模式:视频或音频或两种)
    
    //add by jason 2005-10-11
    h_ctrl_SimpleConfInfoInd,               //mcu通知终端更新会议信息      MC->ter			1字节（0: 不在插话, 1: 在插话）
    
    h_ctrl_terBandWidthInd,                 //nv接收发送带宽通知           ter->MC      u16(接收带宽（包括音频和视频）,网络序) + u16(发送带宽（包括音频和视频）,网络序)
    h_ctrl_terBitrateInfoReq,               //mcu请求终端码率              MC->ter      消息体：无
    h_ctrl_terBitrateInfoRsp,               //nv对终端码率应答             ter->MC      消息体：_TERBITRATE
    ...
    h_ctrl_setAudioVolumeCmd,               /*********************<<  终端音量调节   >>********************
                                             ...
                                             *    +   u8  调整后的音量(NOTE: vx linux 0～32; PCNV: 0～255)
                                             */
	...
	h_ctrl_videoFormatRecoverCmd,			/******************<<  终端分辨率恢复命令   >>****not in use now**********
											 ...
											 * [消息体]  无
											 */
	h_ctrl_nvSelectVmpReq,					/*******************<< 终端（仅限主席NV）选看画面合成请求 >>**************
											 * ter --> MC
											 * [消息体] u8	1表start,0表stop
											 */
	h_ctrl_nvSelectVmpRsp,					/*******************<< 终端（仅限主席NV）选看画面合成应答 >>**************
											 * MC --> ter
											 * [消息体] u8  ok/fail(1表ok，0表fail)
											 */	
    h_ctrl_nvSpeakStatusNtf,                /*******************<< 终端 申请发言中的终端              >>**************
											 * MC --> ter
											 * [消息体] emSpeakerStatus
                                             *
                                                             emWaiting       = 1,        //等待同意；mcu不会发送此状态，终端在发起申请 到 成为发言人通知 到 之前，自动跳入该状态
...
h_ctrl_StartNvVmpReq = 239,		/********** <<终端开启画面合成请求>>*************************
   									 * ter -->Mcu
   									 * [消息体]
	...
	h_ctrl_StartNvVmpRsp = 240,		/***********<<停止终端画面合成请求>>**************************          
									 * ter --> Mcu  
									 * [消息体]
									 * u8(画面合成类型：vccommon.h中定义)
									 */

	h_ctrl_StartNvVmpNotify = 241,	/************<<终端开启画面合成通告>>***************************
   									 * Mcu -->ter
   									 * [消息体]
   									 * u8(0-成功 1-失败)
									 * u8(画面合成类型：vccommon.h中定义)
	...
	h_ctrl_StopNvVmpReq = 242, 		/************<<停止终端画面合成请求>>***************************          
									 * ter --> Mcu  
									 * [消息体]
									 * u8(画面合成类型：vccommon.h中定义)
									 */

	h_ctrl_StopNvVmpRsp = 243,		/************<<停止终端画面合成请求应答>>***************************          
									 * Mcu --> ter 
									 * [消息体]
									 * u8(0-成功 1-失败)
									 * u8(画面合成类型：vccommon.h中定义) */

	h_ctrl_StopNvVmpNotify = 244,   /************<<停止终端画面合成请求应答>>***************************          
									 * Mcu --> ter 
									 * [消息体]
									 * u8(0-成功 1-失败)
									 * u8(画面合成类型：vccommon.h中定义) 
	...
	h_ctrl_ChangeNvVmpReq = 245,	/************<<更改终端画面合成请求>>***************************
 									 * ter -->Mcu
 									 * [消息体]
									 * u8(画面合成类型：vccommon.h中定义)
									 * u8(画面合成方式：vccommon.h中定义)
	...
	h_ctrl_ChangeNvVmpRsp = 246, 	/************<<更改终端自主画面合成请求应答>>***************************
 									 * Mcu -->ter
 									 * [消息体]
									 * u8(0-成功 1-失败)
									 * u8(画面合成类型：vccommon.h中定义)
	...
	h_ctrl_ChangeNvVmpNotify = 247,	/************<<更改终端画面合成通告>>***************************
 									 * Mcu -->ter
 									 * [消息体]
									 * u8(0-成功 1-失败)
									 * u8(画面合成类型：vccommon.h中定义)
...
/*	====================================================================
	...
	void SetMsgId( const u8 &byMsgId )
	{
		...
		u16 wOffSet = ROLLMSG_MSGHEAD_LEN + GetDstNvNum() * sizeof(TNVLABEL) + GetRollMsgContentLen();
...
/*	====================================================================
	...
	u8 GetMsgId(void)
	{
		u16 wOffSet = ROLLMSG_MSGHEAD_LEN + GetDstNvNum() * sizeof(TNVLABEL) + GetRollMsgContentLen() + 1;
	...
	*/
	...
	====================================================================
	*/
	void SetMsgSrcNvId( TNVLABEL tNvId ) {	SetMsgSrcNvId( tNvId.GetMcuNo(), tNvId.GetNvNo() ); }
	/*
	====================================================================
	功能        ：设置消息发源终端
	输入参数说明：<mcu,nv>
	...
	====================================================================
	*/
	void SetMsgSrcNvId( u8 byMcuNo, u8 byNvNo ) 
	{
		*( m_abyBuffer + ROLLMSG_MSGHEAD_SRCNV_OFFSET ) = byMcuNo;
		*( m_abyBuffer + ROLLMSG_MSGHEAD_SRCNV_OFFSET + 1 ) = byNvNo;
	}
	...
	====================================================================
	*/
	TNVLABEL GetMsgSrcNvId( void ) 
	{
		TNVLABEL tMsgSrc;
		u8 byMcuNo = *( m_abyBuffer + ROLLMSG_MSGHEAD_SRCNV_OFFSET );
		u8 byNvNo = *( m_abyBuffer + ROLLMSG_MSGHEAD_SRCNV_OFFSET + 1 );
		tMsgSrc.SetNvLabel( byMcuNo, byNvNo );
		return tMsgSrc; 
	}
	...
	====================================================================
	*/
	u16  GetDstNvNum( void ) 
	{ 
		u16 wNvNum = 0;
		memcpy( &wNvNum, m_abyBuffer + ROLLMSG_MSGHEAD_DSTNVNUM_OFFSET,
			ROLLMSG_MSGHEAD_DSTNVNUM_LEN );
		return ntohs( wNvNum ); 
	}
	...
	====================================================================
	*/
	void SetDstNvList( const TNVLABEL *ptNvList = NULL, u16 wDstNvNum = 0 )
	{
		if ( ptNvList == NULL || wDstNvNum == 0 )
			return;
		...
		if ( wRollMsgLen != 0 )
		{
			...
			u16 wOffSet = ROLLMSG_MSGBODY_OFFSET + wDstNvNum * sizeof( TNVLABEL );
			memcpy( abyRollMsg,
		...
		memcpy( m_abyBuffer + ROLLMSG_MSGBODY_OFFSET, ptNvList, wDstNvNum * sizeof( TNVLABEL ) );

		// 总的消息长度
		u16 wMsgLen = wRollMsgLen + wDstNvNum * sizeof( TNVLABEL ) + ROLLMSG_MSGHEAD_LEN;
		wMsgLen = htons( wMsgLen );
		memcpy( m_abyBuffer + ROLLMSG_MSGHEAD_MSGLEN_OFFSET, &wMsgLen,
				ROLLMSG_MSGHEAD_MSGLEN_LEN );

		// 终端列表长度
		wDstNvNum = htons( wDstNvNum );
		memcpy( m_abyBuffer + ROLLMSG_MSGHEAD_DSTNVNUM_OFFSET, &wDstNvNum,
			ROLLMSG_MSGHEAD_DSTNVNUM_LEN );
	...
	====================================================================
	*/
	void AddDstNv( u8 byMcuNo, u8 byNvNo )
	{
		TNVLABEL tNv;
		tNv.SetNvLabel( byMcuNo, byNvNo );
		AddDstNv( tNv );
	}
	/*
	====================================================================
	...
	====================================================================
	*/
	void AddDstNv( TNVLABEL tNv )
	{
		// 当前终端列表长度
		u16 wDstNvNum = GetDstNvNum();
		// 滚动消息长度
		u16 wRollMsgLen = GetRollMsgContentLen();

		// 总的消息长度
		u16 wMsgLen = wRollMsgLen + ( wDstNvNum + 1 )* sizeof( TNVLABEL ) + ROLLMSG_MSGHEAD_LEN;
		wMsgLen = htons( wMsgLen );
		memcpy( m_abyBuffer + ROLLMSG_MSGHEAD_MSGLEN_OFFSET, &wMsgLen,
			ROLLMSG_MSGHEAD_MSGLEN_LEN );
		...
		// 增加终端
		u16 wOffSet = ROLLMSG_MSGBODY_OFFSET + wDstNvNum * sizeof( TNVLABEL );
		memmove( m_abyBuffer + wOffSet + sizeof( TNVLABEL ),
				m_abyBuffer + wOffSet,
				min( sizeof( m_abyBuffer ) - wOffSet - sizeof( TNVLABEL ), wRollMsgLen ) );
		*( m_abyBuffer + wOffSet ) = tNv.GetMcuNo();
		*( m_abyBuffer + wOffSet + 1 ) = tNv.GetNvNo();

		// 终端列表长度
		wDstNvNum = htons( wDstNvNum + 1 );
		memcpy( m_abyBuffer + ROLLMSG_MSGHEAD_DSTNVNUM_OFFSET, &wDstNvNum,
			ROLLMSG_MSGHEAD_DSTNVNUM_LEN );
	...
	====================================================================
	*/
	TNVLABEL *GetDstNvList( void ) { return ( TNVLABEL* )( m_abyBuffer + ROLLMSG_MSGBODY_OFFSET ); }
	...
	====================================================================
	*/
	int GetFirstDstNv( TNVLABEL *ptNv = NULL ) 
	{
		if ( ptNv == NULL )
			return -1;
		...
		if ( GetDstNvNum() != 0 )
		{
			ptNv->SetNvLabel( *( m_abyBuffer + ROLLMSG_MSGBODY_OFFSET ),
	...
	====================================================================
	功能        ：获取下一个目的终端列表
	输入参数说明：当前终端索引 + TNVLABEL*
	返回值说明  ：正确返回下一个目的终端索引,否则-1
	====================================================================
	*/
	int GetNextDstNv( u16 wIndex, TNVLABEL *ptNv = NULL )
	{
		if ( ptNv == NULL || wIndex >= ( GetDstNvNum() - 1 ) )
			return -1;

		u16 wOffSet = ROLLMSG_MSGBODY_OFFSET + ( wIndex + 1 ) * sizeof( TNVLABEL );
		ptNv->SetNvLabel( *( m_abyBuffer + wOffSet ),
	...
	*/
	void SetRollMsgContent( const u8* pbyRollMsgContent = NULL, u16 wRollMsgLen = 0 )
	{
		...
		// 终端列表
		u16 wDstNvNum = GetDstNvNum();
		memcpy( m_abyBuffer + ROLLMSG_MSGBODY_OFFSET + wDstNvNum * sizeof( TNVLABEL ),
	...
	*/
	...
	{
		u16 wDstNvNum = GetDstNvNum();
		return ( m_abyBuffer + ROLLMSG_MSGBODY_OFFSET + wDstNvNum * sizeof( TNVLABEL ) ); 
	}
	...
	*/
	...
	====================================================================
	*/
	BOOL32 SetRollMsg( const u8 *pbyMsg, u16 wMsgLen )
	{
...
#define GETBITSTATUS(StatusValue, StatusMask) (0 != (StatusValue&StatusMask))
	...
	u8		m_byNvBoardType;				//终端板卡类型	NV_BOARD_WIN, NV_BOARD_8010, ...
...
public:
    // 视频源丢失
    BOOL32    IsVideoLose() const {return GETBITSTATUS(m_byCommStatus, Mask_VidLose); }
    void    SetVideoLose(BOOL32 bIsVideoLose) { SETBITSTATUS(m_byCommStatus, Mask_VidLose, bIsVideoLose)  }    
	
	// 获取终端类型(宏定义)
	u8      GetBoardType() const {return m_byNvBoardType;	}
	void    SetBoardType(u8 byType){ m_byNvBoardType = byType;	}
	...
	//是否允许远摇
	BOOL32    IsRemoteCtrlEnalbe() const {return  (0 != m_bRemoteCtrl);	}
    void    SetRemoteCtrlEnalbe( BOOL32 bEnable) { m_bRemoteCtrl = bEnable ? 1:0;	}
    ...
    //是否哑音
	BOOL32 IsMute() const {return (0 != m_bMute);}
	void SetMute(BOOL32 bMute ){ m_bMute = bMute ? 1:0;}
	
	//是否静音
	BOOL32 IsQuiet() const {return (0 != m_bQuiet);}
	void SetQuiet(BOOL32 bQuiet ){ m_bQuiet = bQuiet ? 1:0;}
...
public:
	...
	BOOL32   operator ==( const TNv & tObj ) const;                  //判断是否相等
	...
	//操作终端函数
	void   SetNv( u8   byMcuId, u8   byNvId, u8   m_byDriId = 0, u8   m_byConfIdx = 0);
	void   SetNv( TNv tNv);
	void   SetNvId( u8   byNvId ){ m_byMainType = TYPE_NV; m_byEqpId = byNvId; }
	u8     GetNvId( void ) const { return m_byEqpId; }//设置终端
	void   SetNvType( u8   byNvType ) { m_byMainType = TYPE_NV; m_bySubType = byNvType; }
	u8     GetNvType( void ) const { return m_bySubType; }  	
	...
	BOOL32   IsNull ( void ) const{ return m_byMcuId == 0 && m_byEqpId == 0; }
	BOOL32   IsLocal() const {	return (m_byMcuId == LOCAL_MCUID );	}
}
/*
#ifndef WIN32
...
//终端轮询参数 (len:12)
struct TNvPollParam: public TNv
{
protected:
...
public:
	...
	TNv   GetTNv(void) const { return *(TNv *)this; }
	void  SetTNv(TNv tNv) { memcpy( this, &tNv, sizeof(tNv) ); }
}
/*
#ifndef WIN32
__attribute__ ( (packed) ) 
...
//定义画面合成成员结构 (len:8)
struct TVMPMember: public TNv
{
protected:
    u8   m_byMemberType;     //画面合成成员类型,参见vccommon.h中画面合成成员类型定义
    u8   m_byMemStatus;      //成员状态(NV_STATUS_CHAIRMAN, NV_STATUS_SPEAKER, NV_STATUS_AUDIENCE)
...
public:
    ...
    void  SetMemberTNv( TNv tNv ){ memcpy( this, &tNv, sizeof(TNv) ); }
}
/*
#ifndef WIN32
__attribute__ ( (packed) ) 
...
protected:
	...
	u8		m_byVMPSeeByChairman;	// 是否被主席NV选看	0-否
...
public:
	...
	BOOL32	IsVMPBatchPoll( void ) const { return m_byVMPBatchPoll == 0 ? FALSE : TRUE;}
	void	SetVMPSeeByChairman(u8 byVMPSeeByNv) { m_byVMPSeeByChairman = byVMPSeeByNv;}
	BOOL32	IsVMPSeeByChairman( void ) const {  return m_byVMPSeeByChairman == 0 ? FALSE : TRUE; }
	...
	BOOL32 IsNvInMember( TNv tNv )
	{
		u8 byLoop = 0;
		u8 byLoopCtrl = 0;
		while( byLoop < GetMaxMemberNum() && byLoopCtrl < MAXNUM_MPUSVMP_MEMBER )
		{
			if( tNv.GetNvId() == m_atVMPMember[byLoop].GetNvId() && 
				tNv.GetMcuId() == m_atVMPMember[byLoop].GetMcuId() )
			{
				return TRUE;
			}
    ...
    BOOL32 IsTypeInMember(u8 byType)
    {
        u8 byLoop = 0;
...
// 				tNv.GetNvId() == m_atVMPMember[byLoop].GetMcuId())
// 			{
// 				return byLoop;				 
// 			}
			if (!m_atVMPMember[byLoop].IsLocal() &&
				tNv.GetNvId() == m_atVMPMember[byLoop].GetNvId()&&
				tNv.GetMcuId() == m_atVMPMember[byLoop].GetMcuId() )
			{
				return byLoop;				 
			}
// endmodify
	...
	void   Print( void ) const
	{
		...
		{
			OspPrintf( TRUE, FALSE, "VMP member %d: NvId-%d, Type-%d\n", 
				i,  m_atVMPMember[i].GetNvId(), m_atVMPMember[i].GetMemberType() );            
		}
	}
}
/*
...
public:
	...
	BOOL32 operator == ( const TKdvTime & tTime );//重载
...
protected:
    ...
    TNvPollParam m_tNvPollParam; //当前被轮询广播的终端及其参数
public:
    ...
    void SetPollNum(u32 dwPollNum) { m_dwPollNum = htonl(dwPollNum); }
    u32  GetPollNum(void) const { return ntohl(m_dwPollNum); }
    void SetNvPollParam(TNvPollParam tNvPollParam){ m_tNvPollParam = tNvPollParam; }
    TNvPollParam GetNvPollParam() const{ return m_tNvPollParam; }
    void Print(void) const
    {
        OspPrintf(TRUE, FALSE, "\nPollInfo:\n");
        ...
        OspPrintf(TRUE, FALSE, "CurPollNv: %d,%d\n", m_tNvPollParam.GetMcuId(),m_tNvPollParam.GetNvId());
    }
}
/*
#ifndef WIN32
...
{
	nvAliasTypeBegin = 0,
	nvAliasTypeTransportAddress = 1,  //终端别名类型: 传输地址
	nvAliasTypeE164,              //终端别名类型: E164号码
	nvAliasTypeH323ID,            //终端别名类型: H323 ID
	nvAliasTypeH320ID,            //终端别名类型: H320 ID类型
    nvAliasTypeH320Alias,         //终端别名类型: H320 别名类型, 不作呼叫信息
	nvAliasTypeOthers,            //终端别名类型: 其它
...
public:
	TNvAlias( void ){ memset( this, 0, sizeof(TNvAlias) ); }
	BOOL32 operator ==( const TNvAlias & tObj ) const;
	BOOL32 IsNull( void ) const { if( m_AliasType == 0 )return TRUE; return FALSE; }
	void SetNull( void ){ memset(this, 0, sizeof(TNvAlias)); }
	BOOL32 IsAliasNull( void ) const { return 0 == strlen(m_achAlias); }
	void SetE164Alias( LPCSTR lpzAlias )
	{
		if( lpzAlias != NULL )
		{
			m_AliasType = nvAliasTypeE164;
	...
	BOOL32 GetH320Alias ( u8 &byLayer, u8 &bySlot, u8 &byChannel )
	{
		...
		bySlot    = 0; 
		byChannel = 0; 
		if( nvAliasTypeH320ID != m_AliasType )
		{
			return bRet;
		}
...
public:
    ...
    void AddMember(u8 byNvId)
    {
        if (byNvId == 0)
            return;
        
        if (m_byNvNum < MAXNUM_MIXING_MEMBER)
        {
            m_abyNvList[m_byNvNum++] = byNvId;
        }        
    }
    void DelMember(u8 byNvId)
    {
        if (byNvId == 0)
            return;

        for (u8 byLoop = 0; byLoop < m_byNvNum; byLoop ++ )
        {
            if (m_abyNvList[byLoop] == byNvId)
            {
                for ( u8 byMove = byLoop+1; byMove < m_byNvNum; byMove ++ )
                {
                    m_abyNvList[byMove-1] =  m_abyNvList[byMove];
                }
                m_byNvNum --;
                break;
            }
    ...
    {
        if ( byIdx < m_byNvNum )
            return m_abyNvList[byIdx];
        else
            return 0;
    }

    BOOL32 IsNvInMember(u8 byNvId) const
    {
        for (u8 byLoop = 0; byLoop < m_byNvNum; byLoop ++ )
        {
            if (m_abyNvList[byLoop] == byNvId)
    ...
    void SetNvMaxNum(u8 byNvMaxNum){ m_byNvMaxNum = byNvMaxNum;    }
    u8   GetNvMaxNum(void) const { return m_byNvMaxNum;    }
protected:
    ...
    u8  m_byNvNum;
    u8  m_abyNvList[MAXNUM_MIXING_MEMBER];
    u8  m_byNvMaxNum;   //  记录使用的混音器最大成员数,恢复与启动备份时用到
private:
    u8  m_abyReserved[3];
}
PACKED
...
public:
    ...
    void   SetEncKeyManual(BOOL32  bEncKeyManual){ m_byEncKeyManual = bEncKeyManual; }
    BOOL32   IsEncKeyManual( void ) const { return m_byEncKeyManual == 0 ? FALSE : TRUE; }
    ...
    BOOL32   IsReleaseNoNv( void ) const { return m_byReleaseMode == 0 ? FALSE : TRUE; }
    ...
    void   SetSatDCastMode ( BOOL32 bSatDCastMode ) { m_bySatDCastMode = bSatDCastMode; }
    BOOL32   IsSatDCastMode () const { return m_bySatDCastMode == 0 ? FALSE : TRUE;    }
...
public:
    ...
    void SetGKUsrName(LPCSTR pszName)
    {
        if ( pszName != NULL )
        {
			u16 wTmplen = strlen( pszName );
            u16 wLen = min( MAX_LEN_GK_USRNAME-1, wTmplen );
    ...
    void SetGKPwd(LPCSTR pszPwd)
    {
        if ( pszPwd != NULL )
        {
			u16 wTmplen = strlen( pszPwd );
            u16 wLen = min( MAX_LEN_GK_PWD-1, wTmplen );
    ...
    void Print() const
    {
		...
		OspPrintf( TRUE, FALSE, "Has ConfEx info :    %d\n", ((m_byConfExInfo&0x08)>>3));
    }
	...
	//判断是否是端口媒体会议[4/10/2014 yanghuaizhi]
...
/*电视墙模板结构和画面合成模板结构说明:
目前创会时的消息体: TConfInfo + 2 byte(TNvAlias数组打包长度,即下面的n)
                  + n byte(TNvAlias数组打包) + TMultiTvWallModule(可选) + TVmpModule(可选) */
//电视墙模板结构
struct TTvWallModule
{
	TEqp m_tTvWall;                                     //会控指定的电视墙
    u8   m_abyTvWallMember[MAXNUM_PERIEQP_CHNNL];       //会控指定的电视墙成员索引（即创会时TNvAlias数组索引+1）
...
public:
    ...
    void SetTvChannel(u8 byTvChl, u8 byNvIdx, u8 byMemberType) // 设置指定通道
    {
        if(byTvChl < MAXNUM_PERIEQP_CHNNL)
        {
            m_abyTvWallMember[byTvChl] = byNvIdx;
    ...
    void RemoveNvInTvMember(u8 byNvIdx) // 移除电视墙中所有该终端
    {
        for(u8 byTvChlLp = 0; byTvChlLp < MAXNUM_PERIEQP_CHNNL; byTvChlLp++)
        {
            if(m_abyTvWallMember[byTvChlLp] == byNvIdx)
            {
...
public:
    ...
    void SetTvWallMember(u8 byTvId, u8 byTvChl, u8 byNvIdx, u8 byMemberType)
    {
        for(u8 byTvLp = 0; byTvLp < MAXNUM_PERIEQP_CHNNL; byTvLp++)
        {
            if(m_atTvWallModule[byTvLp].GetTvEqp().GetEqpId() == byTvId)
            {
                m_atTvWallModule[byTvLp].SetTvChannel(byTvChl, byNvIdx, byMemberType);
                break;
            }
        }
    }

    void RemoveNvByTvId(u8 byTvId, u8 byNvIdx )
    {
        for(u8 byTvLp = 0; byTvLp < MAXNUM_PERIEQP_CHNNL; byTvLp++)
        {
            if(m_atTvWallModule[byTvLp].GetTvEqp().GetEqpId() == byTvId)
            {
                m_atTvWallModule[byTvLp].RemoveNvInTvMember(byNvIdx);
                break;
            }
        }
    }
...
{                        
	...
	u8        m_abyVmpMember[MAXNUM_MPUSVMP_MEMBER];        //会控指定的画面合成成员索引（即创会时TNvAlias数组索引+1）
    ...
    // 设置某个通道
    void SetVmpMember(u8 byChnlIdx, u8 byNvIdx, u8 byMemberType)
    {
        if (byChnlIdx < MAXNUM_VMP_MEMBER)
        {
            m_abyVmpMember[byChnlIdx]  = byNvIdx;
...
public:
    ...
    void    SetSpeaker(const TNv & tSpeaker) { m_tSpeaker = tSpeaker; }
    TNv     GetSpeaker(void) const { return m_tSpeaker; }
    void    SetChairman(const TNv & tChair) { m_tChairMan = tChair; }
    TNv     GetChairman(void) const { return m_tChairMan; }
}
/*
#ifndef WIN32
__attribute__ ( (packed) ) 
...
// 	BOOL32   IsDiscussMode( void ) const { return m_byDiscussMode == 0 ? FALSE : TRUE; }
	...
	//判断是不是语音激励
	BOOL32   IsVACMode( void ) const { return (m_byMixMode == mcuVacMix) || (m_byMixMode == mcuVacWholeMix) || (m_byMixMode == mcuVacPartMix) ? TRUE : FALSE; }
	//判断是不是会议讨论
	BOOL32   IsDiscussMode( void ) const { return (m_byMixMode == mcuWholeMix) || (m_byMixMode == mcuVacWholeMix) ? TRUE : FALSE; }
	//判断时候是定制混音
	BOOL32   IsSpecMix( void ) const {return (m_byMixMode == mcuPartMix) || (m_byMixMode == mcuVacPartMix) ? TRUE : FALSE; }
...
protected:
    ...
    u8     m_byReserved6;
	//u8     m_byMixSpecNv;		//是否指定终端混音: 0-不是定制混音(智能混音) 1-指定终端混音
...
public:
	...
	BOOL32   IsRegToGK( void ) const { return m_byRegToGK == 0 ? FALSE : TRUE; }
    void   SetGkCharge( BOOL32 bCharge ) { m_byGkCharge = bCharge ? 1 : 0; }
    BOOL32   IsGkCharge( void ) const { return (1 == m_byGkCharge ? TRUE : FALSE); }
    ...
    BOOL32   GetHDBasMode( u8  byHDBasMode ) const 
    {
    ...
    //void   SetMixSpecNv( BOOL32 bMixSpecNv ){ m_byMixSpecNv = bMixSpecNv;} 
    //BOOL32   IsMixSpecNv( void ) const { return m_byMixSpecNv == 0 ? FALSE : TRUE; }
	void   Print( void ) const
	{
		OspPrintf( TRUE, FALSE, "\nConfMode:\n" );
		...
		//OspPrintf( TRUE, FALSE, "m_byMixSpecNv: %d\n", m_byMixSpecNv);
...
{
public:
    TNv 	      m_tChairman;	      //主席终端，MCU号为0表示无主席
    TNv		      m_tSpeaker;		  //发言终端，MCU号为0表示无发言人
...
public:
    BOOL32   HasChairman(void) const { return m_tChairman.GetNvId()==0 ? FALSE : TRUE; }	
	TNv    GetChairman(void) const { return m_tChairman; }
	void   SetNoChairman(void) { memset( &m_tChairman, 0, sizeof( TNv ) ); }
	void   SetChairman(TNv tChairman) { m_tChairman = tChairman; }
	BOOL32   HasSpeaker(void) const { return m_tSpeaker.GetNvId()==0 ? FALSE : TRUE; }
    TNv    GetSpeaker(void) const { return m_tSpeaker; }
	void   SetNoSpeaker(void) { memset( &m_tSpeaker, 0, sizeof( TNv ) ); }
	void   SetSpeaker(TNv tSpeaker) { m_tSpeaker = tSpeaker; }
	...
	//会议进行状态
	BOOL32 IsScheduled( void ) const { return m_tConfMode.GetTakeMode() == CONF_TAKEMODE_SCHEDULED ? TRUE : FALSE; }
	void SetScheduled( void ){ m_tConfMode.SetTakeMode( CONF_TAKEMODE_SCHEDULED ); }
	BOOL32 IsOngoing( void ) const { return m_tConfMode.GetTakeMode() == CONF_TAKEMODE_ONGOING ? TRUE : FALSE; }
	void SetOngoing( void ){ m_tConfMode.SetTakeMode( CONF_TAKEMODE_ONGOING ); }
	BOOL32 IsTemplate( void ) const { return m_tConfMode.GetTakeMode() == CONF_TAKEMODE_TEMPLATE ? TRUE : FALSE; }
    ...
    BOOL32 IsTakeFromFile(void) const{ return m_tConfMode.IsTakeFromFile(); }
    ...
    void   SetAutoMixing(BOOL32 bAutoMix = TRUE)
    {
    ...
    void   SetSpecMixing(BOOL32 bMixSpecNv = TRUE)
    {
        u8 byMixMode = mcuNoMix;
        if ( bMixSpecNv )
        {
    ...
    void   SetVACing(BOOL32 bVACMode = TRUE)
    {
        u8 byMixMode = mcuNoMix;
        if ( bVACMode )
        {
	...
	BOOL32   IsBrdstVMP( void ) const { return m_tVMPParam.GetVMPMode() != CONF_VMPMODE_NONE && m_tVMPParam.IsVMPBrdst(); }
	...
	void   SetVmpSeebyChairman( BOOL32 bSeebyChair){ m_tVMPParam.SetVMPSeeByChairman(bSeebyChair); }
	BOOL32   IsVmpSeeByChairman( void ) const {return m_tVMPParam.IsVMPSeeByChairman();}
    //vmp tvwall    
    ...
    void   SetNvPollParam(TNvPollParam tNvPollParam){ m_tPollInfo.SetNvPollParam( tNvPollParam ); } 
    TNvPollParam  GetNvPollParam() const{ return m_tPollInfo.GetNvPollParam(); }
    ...
    void   SetTvWallNvPollParam(TNvPollParam tNvPollParam){ m_tTvWallPollInfo.SetNvPollParam( tNvPollParam ); } 
    TNvPollParam  GetTvWallNvPollParam(){ return m_tTvWallPollInfo.GetNvPollParam(); }
    ...
    void   SetHduNvPollParam(TNvPollParam tNvPollParam){ m_tHduPollInfo.SetNvPollParam( tNvPollParam ); } 
    TNvPollParam  GetHduNvPollParam(){ return m_tHduPollInfo.GetNvPollParam(); }

	//会议录像状态	
	BOOL32 IsNoRecording( void ) const{ return m_tConfMode.GetRecordMode() == CONF_RECMODE_NONE ? TRUE : FALSE; }
	void SetNoRecording( void ){ m_tConfMode.SetRecordMode( CONF_RECMODE_NONE ); }
	BOOL32 IsRecording( void ) const{ return m_tConfMode.GetRecordMode() == CONF_RECMODE_REC ? TRUE : FALSE; }
	void SetRecording( void ){ m_tConfMode.SetRecordMode( CONF_RECMODE_REC ); }
	BOOL32 IsRecPause( void ) const{ return m_tConfMode.GetRecordMode() == CONF_RECMODE_PAUSE ? TRUE : FALSE; }
	void SetRecPause( void ){ m_tConfMode.SetRecordMode( CONF_RECMODE_PAUSE ); }

	//会议放像状态
	BOOL32 IsNoPlaying( void ) const{ return m_tConfMode.GetPlayMode() == CONF_PLAYMODE_NONE ? TRUE : FALSE; }
	void SetNoPlaying( void ){ m_tConfMode.SetPlayMode( CONF_PLAYMODE_NONE ); }
	BOOL32 IsPlaying( void ) const { return m_tConfMode.GetPlayMode() == CONF_PLAYMODE_PLAY ? TRUE : FALSE; }
	void SetPlaying( void ){ m_tConfMode.SetPlayMode( CONF_PLAYMODE_PLAY ); }
	BOOL32 IsPlayPause( void )const { return m_tConfMode.GetPlayMode() == CONF_PLAYMODE_PAUSE ? TRUE : FALSE; }
	void SetPlayPause( void ){ m_tConfMode.SetPlayMode( CONF_PLAYMODE_PAUSE ); }
	BOOL32 IsPlayFF( void )const { return m_tConfMode.GetPlayMode() == CONF_PLAYMODE_FF ? TRUE : FALSE; }
	void SetPlayFF( void ) { m_tConfMode.SetPlayMode( CONF_PLAYMODE_FF ); }
	BOOL32 IsPlayFB( void )const { return m_tConfMode.GetPlayMode() == CONF_PLAYMODE_FB ? TRUE : FALSE; }
	void SetPlayFB( void ){ m_tConfMode.SetPlayMode( CONF_PLAYMODE_FB ); }
	// zgc, 2007-02-27, 会议放像关键帧延迟问题
	BOOL32 IsPlayReady( void ) const{ return m_tConfMode.GetPlayMode() == CONF_PLAYMODE_PLAYREADY ? TRUE : FALSE; }
	...
	BOOL32 IsRegToGK( void ) const{ return m_tConfMode.IsRegToGK(); }

    // xsl [11/16/2006] GK计费情况
    void SetGkCharge( BOOL32 bCharge ) { m_tConfMode.SetGkCharge( bCharge ); }
    BOOL32 IsGkCharge( void ) const { return m_tConfMode.IsGkCharge(); }
	...
	void Print( void ) const
	{
        ...
        if(m_tChairman.IsNull())  
            ...
            OspPrintf( TRUE, FALSE, "Chairman: Mcu%dNv%d\n", m_tChairman.GetMcuId(), m_tChairman.GetNvId() );
        if(m_tSpeaker.IsNull())
            OspPrintf( TRUE, FALSE, "Speaker: Null\n" );
        else
		    if (m_tSpeaker.GetType() == TYPE_NV)
                OspPrintf( TRUE, FALSE, "Speaker: Mcu%dNv%d\n", m_tSpeaker.GetMcuId(), m_tSpeaker.GetNvId() );
            else
...
{
protected:
	u16		m_wMaxBitRate;   //// 最高位标识HP/BP属性，为1标识HP，为0表示BP [12/2/2011 chendaiwei], 2016/4/22，5.0终端要支持创会Hp, 加的
    u8		m_byMediaType;   
...
protected:
    ...
    TNvAlias      m_tChairAlias;                    //会议中主席的别名
    TNvAlias      m_tSpeakerAlias;                  //会议中发言人的别名
...
public:	
    ...
    void   SetChairAlias(TNvAlias tChairAlias){ m_tChairAlias = tChairAlias;} 
    TNvAlias  GetChairAlias( void ) const { return m_tChairAlias; }
    void   SetSpeakerAlias(TNvAlias tSpeakerAlias){ m_tSpeakerAlias = tSpeakerAlias;} 
    TNvAlias  GetSpeakerAlias( void ) const { return m_tSpeakerAlias; }
	...
	BOOL32   HasChairman( void ) const{ if(m_tStatus.m_tChairman.GetNvId()==0)return FALSE; return TRUE; }	
	TNv    GetChairman( void ) const{ return m_tStatus.m_tChairman; }
	void   SetNoChairman( void ){ memset( &m_tStatus.m_tChairman, 0, sizeof( TNv ) ); }
	void   SetChairman( TNv tChairman ){ m_tStatus.m_tChairman = tChairman; }
	BOOL32   HasSpeaker( void ) const{ if(m_tStatus.m_tSpeaker.GetNvId()==0)return FALSE; return TRUE; }
    TNv    GetSpeaker( void ) const{ return m_tStatus.m_tSpeaker; }
	void   SetNoSpeaker( void ){ memset( &m_tStatus.m_tSpeaker, 0, sizeof( TNv ) ); }
	void   SetSpeaker( TNv tSpeaker ){ m_tStatus.m_tSpeaker = tSpeaker; }
    ...
    BOOL32   IsVmpAutoAdapt() const { return m_tConfAttrbEx.IsVmpAutoAdapt(); }
    BOOL32   IsSupportGkCharge(void) const { return ( strlen(m_tConfAttrbEx.GetGKUsrName()) > 0 ? TRUE : FALSE ); }
    ...
    BOOL32   IsDiscussAutoStop() const { return m_tConfAttrbEx.IsDiscussAutoStop(); }
	...
	BOOL32 IsConfRealSat(void) {	return m_tConfAttrbEx.IsConfRealSat();	};
...
----------------------------------------------------------------------
	...
	04/06/28    3.0         胡昌威        修改
====================================================================*/
inline BOOL32 TNv::operator ==( const TNv & tObj ) const
{
	...
	case TYPE_MCUPERI:
		...
		break;
	case TYPE_NV:
        if( tObj.GetMcuId() == GetMcuId() && tObj.GetNvId() ==  GetNvId() 
...
====================================================================*/
inline void TNv::SetMcu( u8 byMcuId )
{
...
----------------------------------------------------------------------
    ...
    2003/10/28  3.0         胡昌威        修改  
====================================================================*/
inline void TNv::SetMcuEqp( u8 byMcuId, u8 byEqpId, u8 byEqpType )
{
...
----------------------------------------------------------------------
    ...
    2003/10/28  3.0         胡昌威        修改  
====================================================================*/
inline void TNv::SetNv( u8 byMcuId, u8 byNvId, u8 byDriId, u8 byConfIdx )
{
	m_byMainType = TYPE_NV;
	m_bySubType = 0;
	m_byMcuId = byMcuId;
	m_byEqpId = byNvId;	
...
====================================================================*/
inline void TNv::SetNv( TNv tNv )
{
	SetNv(tNv.GetMcuId(), tNv.GetNvId(), tNv.GetDriId(), tNv.GetConfIdx());
}
...
====================================================================*/
inline BOOL32 CConfId::IsNull( void ) const
{
...
----------------------------------------------------------------------
    ...
    02/12/31    1.0         LI Yi         创建
====================================================================*/
inline BOOL32 CConfId::operator == ( const CConfId & cConfId ) const
{
...
====================================================================*/
inline  BOOL32   TNvAlias::operator ==( const TNvAlias & tObj ) const
{
	...
	if( tObj.m_AliasType == nvAliasTypeTransportAddress )
	{
...
----------------------------------------------------------------------
    ...
    03/06/07    1.0         李屹          创建
====================================================================*/
inline BOOL32 TKdvTime::operator == ( const TKdvTime & tTime )
{
...
protected:
	...
	u8		m_byVMPBatchPoll; // xliang [12/18/2008] 是否是批量轮询 0-否
	u8		m_byReserved2;	  //保留字段
	TVMPMember  m_atVMPMember[16/*MAXNUM_VMP_MEMBER 该宏已经被同化到20，不能再使用*/]; //画面合成成员
public:
    void   SetVMPAuto(u8   byVMPAuto){ m_byVMPAuto = byVMPAuto;} 
    BOOL32   IsVMPAuto( void ) const { return m_byVMPAuto == 0 ? FALSE : TRUE; }
    void   SetVMPBrdst(u8   byVMPBrdst){ m_byVMPBrdst = byVMPBrdst;} 
...
public:
    ...
    //混音方式（是智能还是定制混音）
    BOOL32 IsMixSpecNv(void) const { return m_tConfMode.IsMixSpecNv(); }
    void   SetMixSpecNv(BOOL32 bMixSpecNv) { m_tConfMode.SetMixSpecNv(bMixSpecNv); }
    ...
    { memcpy(m_tDiscussParam.m_atNvMember, tAudMixParam.m_atNvMember, sizeof(tAudMixParam.m_atNvMember)); } 
...
public:
    ...
    void AddMember(u8 byNvId)
    {
        ...
        if (m_byNvNum < MAXNUM_MIXING_MEMBER_BEFORE)
        {
            m_abyNvList[m_byNvNum++] = byNvId;
        }        
    }
...
protected:
    u8  m_byMixMode;    //混音模式：mcuNoMix - 不混音
                        ...
                        //          mcuVacWholeMix - 带Vac的全体混音
    u8  m_byNvNum;
    u8  m_abyNvList[MAXNUM_MIXING_MEMBER_BEFORE];
private:
    u8  m_abyReserved[4];
}
PACKED
...
#endif  //_NV_H323STACKCOMPATIBLE_H