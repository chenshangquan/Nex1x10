#if !defined(_MTMACRO_H_)
#define _MTMACRO_H_

#ifdef _MSC_VER
#  define MTCBB_API  __declspec(dllexport)
#else
#  define MTCBB_API
#endif  // _MSC_VER
...
{\
	...
	{\
        mtPrintf("SAFE_MEMCPY Invalid Param(pDst:%0x,dwDstSize:%d,pSrc:%0x,dwSrcSize:%d)(%s:(%d))!", pDst, dwDstSize, pSrc, dwSrcSize, __FILE__, __LINE__);  \
	}\
	else\
	{\
