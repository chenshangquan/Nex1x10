#ifndef _MTSYSCTRLMSG_H_
#define _MTSYSCTRLMSG_H_
...
enum EmMtSysCtrlMsg
{
    EV_BGN(MTSYSCTRL) = EVSEG_SYSCTRL_BGN,
#endif
	...
	* 发送方向：各个子系统 -> mtsysctrl -> mtsdk（看界面需要，是否需要发送到mtsdk）
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_SrvEndtResult_Ntf)
	...
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_SrvKeepAlive_Ntf)  
	...
	* 发送方向：暂时未定
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_GetDataShareSrvCmd)	
	...
	* 发送方向：mtsdk -> mtsysctrl
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_SrvAddSrvDefListCmd)
	...
	* 发送方向：mtsdk -> mtsysctrl
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_SrvModifySrvDefListCmd)
	BODY(mt::TMutiTServiceDefInfo, tMutiTServiceDefInfo)
	...
	* 发送方向：mtsdk -> mtsysctrl
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_SrvDelSrvDefListCmd)
	...
	* 参数：TServiceInfo：	
	* ----------------------------------------------------------
	* 发送方向：mtservice -> mthddetect
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_ThreadDetectRegCmd)
	...
	* 发送方向：mtservice -> mthddetect
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_ThreadDetectUpdateCmd)
	...
	* 参数：
	* ----------------------------------------------------------
	* 发送方向：mthddetect -> mtservice -> 组件
	* ******************************************************************************** */ 
	MESSAGE(Ev_MT_ThreadDetectUpdateNtf)

    /**********************************************************************************
	* < 通知mthddetect开启定时监测mp模块启动状况>
	* ----------------------------------------------------------
	* 参数：TBOOL32 mp是否启动完成
	* ----------------------------------------------------------
	* 发送方向：mtmpapp -> mthddetect
	* ******************************************************************************** */ 
    MESSAGE(Ev_MT_MTMPRuningCheckCmd)
    BODY(mt::TBOOL32, bReady)

 #if !defined(_MESSAGE_HELP_)
     EV_END(MTSYSCTRL) = EVSEG_SYSCTRL_END
};
#endif

#define Is_MtSysCtrl_Msg(m) ((m) >= EV_BGN(MTSYSCTRL) && (m) <= EV_END(MTSYSCTRL))
