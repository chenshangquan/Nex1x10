...
#include "nvmacro.h"
	...
	const HANDLE NV_INVALID_IPC_SEMHANDLE = NULL;
	...
	const s32 NV_INVALID_IPC_SEMHANDLE = -1;
	const s32 NV_IPC_SEM_FAILED = -1;
...
namespace NVUTILS
{
	...
	public:
		...
		*
		**************************************************************/
		BOOL32 IsValidSem(){ return (m_hSem != NV_INVALID_IPC_SEMHANDLE); }
	 ...
	 */
	/*---------------------------------------------------------------------------*/
	class NVCBB_API CSharedMemoryBlock
	{
	public:
