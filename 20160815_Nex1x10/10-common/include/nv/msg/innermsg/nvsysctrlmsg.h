#ifndef _NVSYSCTRLMSG_H_
#define _NVSYSCTRLMSG_H_
...
enum EmNvSysCtrlMsg
{
    EV_BGN(NVSYSCTRL) = EVSEG_SYSCTRL_BGN,
#endif
	...
	* 发送方向：各个子系统 -> nvsysctrl -> nvsdk（看界面需要，是否需要发送到nvsdk）
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_SrvEndtResult_Ntf)
	...
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_SrvKeepAlive_Ntf)  
	...
	* 发送方向：暂时未定
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_GetDataShareSrvCmd)	
	...
	* 发送方向：nvsdk -> nvsysctrl
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_SrvAddSrvDefListCmd)
	...
	* 发送方向：nvsdk -> nvsysctrl
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_SrvModifySrvDefListCmd)
	BODY(nv::TMutiTServiceDefInfo, tMutiTServiceDefInfo)
	...
	* 发送方向：nvsdk -> nvsysctrl
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_SrvDelSrvDefListCmd)
	...
	* 参数：TServiceInfo：	
	* ----------------------------------------------------------
	* 发送方向：nvservice -> nvhddetect
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_ThreadDetectRegCmd)
	...
	* 发送方向：nvservice -> nvhddetect
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_ThreadDetectUpdateCmd)
	...
	* 参数：
	* ----------------------------------------------------------
	* 发送方向：nvhddetect -> nvservice -> 组件
	* ******************************************************************************** */ 
	MESSAGE(Ev_NV_ThreadDetectUpdateNtf)

	MESSAGE(Ev_NV_HDNvStartSucess_Ntf)

	MESSAGE(Ev_NV_GetE2ROM_Reg)

	MESSAGE(Ev_NV_ShowImixInfo_Reg)
	

 #if !defined(_MESSAGE_HELP_)
     EV_END(NVSYSCTRL) = EVSEG_SYSCTRL_END
};
#endif

#define Is_NvSysCtrl_Msg(m) ((m) >= EV_BGN(NVSYSCTRL) && (m) <= EV_END(NVSYSCTRL))
