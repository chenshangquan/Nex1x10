...
enum EM_ERROR_MODULE
{
	...
	emErrorModuleMtConf,            ///< 终端会议子系统
	emErrorModuleMtVod,            ///< 终端点播子系统
	emErrorModuleMtpa,              ///<
	emErrorModuleMtmc,              ///<内置mc模块

	                                ///< 不超30，可再此前面进行MTCBB模块的扩展
