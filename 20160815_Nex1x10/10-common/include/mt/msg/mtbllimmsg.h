#ifndef _MTBLLIMMSG_H_
#define _MTBLLIMMSG_H_
...
enum EmBLLMtImMsg
{
    EV_BLL_BGN(MTIM) = EVSEG_BLL_IM_BGN,
#endif
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImLogOut_Cmd)		
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQuerySelfDefInfo_Req)			
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQuerySelfDefInfo_Rsp)			
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImModifySelfDefInfo_Req)			
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSelfDefInfo, SelfDefInfo)
	BODY(mt::TImSelfDefPic, SelfDefPic)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImModiySelfDefInfo_Rsp)			
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSelfDefInfo, SelfDefInfo)
	BODY(mt::TImSelfDefPic, SelfDefPic)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryUserSelfDefInfo_Req)			
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryUserSelfDefInfo_Rsp)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryGroupInfo_Req)			
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryGroupInfo_Error_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryGroupInfo_Rsp)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryGroupInfo_Fin_Rsp)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryGroupInfoByGroupSn_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryGroupInfoByGroupSn_Error_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryGroupInfoByGroupSn_Rsp)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImGroupList, TImGroupList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryGroupInfoByGroupSn_Fin_Rsp)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImAddGroupInfo_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImAddGroupInfo_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImGroupInfo, TImGroupInfo)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImDelGroupInfo_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImDelGroupInfo_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	BODY(mt::TBOOL32, bReserved)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImModifyGroupInfo_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImGroupInfo, TImGroupInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImModifyGroupInfo_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImGroupInfo, TImGroupInfo)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryMemberInfoByGroupSn_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryMemberInfoByGroupSn_Error_Rsp)
	BODY(mt::TU32, emErrorID)	
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryMemberInfoByGroupSn_Rsp)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryMemberInfoByGroupSn_Fin_Rsp)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImAddMemberInfo_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImAddMemberInfo_Rsp)					
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryAddMemberInfo_Rsp)	
	//BODY(mt::TU32, Errid)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImCopyMember_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMemberInfo, TImMemberInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImCopyMember_Rsp)					
	BODY(mt::TU32, emErrorID)						// 成功时填写的内容
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMemberFullInfo, TImMemberFullInfo)
	/************************************/					
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImDelMemberInfo_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImDelMemberInfo_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImModifyMemberInfo_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMemberInfo, TImMemberInfo)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImModifyMemberInfo_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMemberInfo, TImMemberInfo)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMoveMemberInfo_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMoveMemberInfo_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
 	BODY(mt::TImMoveMember, TImMoveMember)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMemberOnlineStateChange_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSn_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSn_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSn_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSn_Fin_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSnEx_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSnEx_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSnEx_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSnEx_Fin_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImModifySelfState_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImModifySelfState_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSetUserState, TImSetUserState)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImSendP2PMessage_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImSendP2PMessage_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImP2PChatMessage, TImP2PChatMessage)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImSendP2PMessage_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImP2PChatMessage, TImP2PChatMessage)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendP2PMessageInstant_Rsp)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImP2PChatMessage, TImP2PChatMessage)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatCreate_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatCreate_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMulitChatCreateInfo, TImMulitChatCreateInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatCreate_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMulitChatCreateInfo, TImMulitChatCreateInfo)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatDestroy_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, ChatID)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
 	MESSAGE(Ev_MT_BLL_ImMulitChatDestroy_Rsp)
 	BODY(mt::TU32, emErrorID)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TU32, ChatID)
 	BODY(mt::TRoomId, TRoomId)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
 	MESSAGE(Ev_MT_BLL_ImMulitChatDestroy_Ntf)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TU32, ChatID)
 	BODY(mt::TRoomId, TRoomId)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatAddMember_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatAddMember_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatMemberInfo, TImMultiChatMemberInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatAddMember_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatMemberInfo, TImMultiChatMemberInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatMemberStatusChange_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatDelMember_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatMemberInfo, TImMultiChatMemberInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatDelMember_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TRoomId, TRoomId)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatDelMember_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatMemberInfoEx, TImMultiChatMemberInfoEx)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatQuit_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, ChatID)
	BODY(mt::TRoomId, TRoomId)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatQuit_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, ChatID)
	BODY(mt::TRoomId, TRoomId)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImMulitChatMemberLeave_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatMemberInfoEx, TImMultiChatMemberInfoEx)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImSendMulitSMS_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImSendMulitSMS_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatMessage, TImMultiChatMessage)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImSendMulitSMS_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatMessage, TImMultiChatMessage)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendMulitSMSInstant_Rsp)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatMessage, TImMultiChatMessage)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImClearDir_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImClearDir_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImRetryLogin_Cmd)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendFile_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendFile_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImAcceptFile_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, SessionID)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImAcceptFile_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TBOOL32, bRecv)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImCancelFile_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, SessionID)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImCancelFile_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, SessionID)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImFileShareOffer_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, SessionID)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImFileShareStart_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, SessionID)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImFileShareComplete_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, SessionID)
	BODY(mt::TString, achPath)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImFileShareCancel_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, SessionID)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImFileShareFailure_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, SessionID)
	BODY(mt::TU32, emErrorID)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImFileShareProgress_Ntf)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TU32, SessionID)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetFileSavePath_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetFileSavePath_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TString, Path)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGroupAdd_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImGroupInfo, TImGroupInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGroupDel_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGroupModify_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImGroupInfo, TImGroupInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMemberAdd_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMemberInfo, TImMemberInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMemberDel_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMemberModify_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMemberInfo, TImMemberInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMemberMove_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMoveMember, TImMoveMember)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImEnterPersistentRoom_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMulitChatCreateInfo, TImMulitChatCreateInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImEnterPersistentRoomForAndroid_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMulitChatCreateInfo, TImMulitChatCreateInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImEnterPersistentRoomFail_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImDisconnected_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQuerySubscribe_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNO, TImNO)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendGroupChatFile_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImSendGroupChatFile_Rsp)
 	BODY(mt::TU32, emErrorID)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TImGroupChatFileShareReq, TImGroupChatFileShareReq)
	...
	* 发送方向：mtim -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImInnerNotifyCreateChatRoom_Ntf)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImIosSetTempPath_Cmd)
	BODY(mt::TString, achPath)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetFileTransferBitRate_Req)
	BODY(mt::TU32, dwRate)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetFileTransferBitRate_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, dwRate)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetChatroomMessagesReadFlag_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetChatroomMessagesReadFlag_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImPushMemberStatus_Ntf)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMembersDataReady_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetUsersState_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNOList, TImNOList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetUsersState_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNOList, TImNOList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetUsersState_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImUserStateList, TImUserStateList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetUsersState_Fin_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNOList, TImNOList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetUsersStateEx_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNOList, TImNOList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetUsersStateEx_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNOList, TImNOList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetUsersStateEx_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImUserStateListEx, TImUserStateListEx)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetUsersStateEx_Fin_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNOList, TImNOList)
	...
	* 发送方向：mtim -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImInnerNotifyAcceptInvite_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImNotifySecurity_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImNotifyOfflineMsgOverflow_Ntf)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetChatroom_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetChatroom_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImChatRoomInfo, TImChatRoomInfo)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImNotifyRoomConfig_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImChatRoomInfo, TImChatRoomInfo)
	...
	* 发送方向：mtim -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImInnerNotifyStanza_Ntf)
	BODY(mt::bytes, print)
	...
	* 发送方向：mtim -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImInnerDebug_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImInnerXmppInfo_Ntf)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImDecline_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomRosterItemsAdd_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomRosterItemsDel_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImMultiChatRosterItemList, TImMultiChatRosterItemList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomServiceAvailable_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomPictureOpen_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomPictureData_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TMultiChatPicId, TMultiChatPicId)
	BODY(mt::TU32, dwPos)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomPictureClose_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TMultiChatPicId, TMultiChatPicId)
	BODY(mt::TString, achPath)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomPictureFail_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TMultiChatPicId, TMultiChatPicId)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomMemberAdd_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImChatroomMemberBatch_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImPersistentChatrooms_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImPersistentChatrooms_Fin_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryEnterSavedPersistentChatrooms_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TPersistentChatroomList, TPersistentChatroomList)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryEnterSavedPersistentChatrooms_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TPersistentChatroomList, TPersistentChatroomList)
	...
	* 发送方向：mtim -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetReady_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetReady_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, time)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSetReady_Ntf)			
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSnAndPosition_Req)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TImSn, TImSn)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImQueryOnlineStateByGroupSnAndPosition_Rsp)
  	BODY(mt::TU32, emErrorID)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TImSn, TImSn)
 	BODY(mt::TU32, dwPosition)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImQueryMemberInfoByGroupSnAndPosition_Req)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TImSn, TImSn)
 	BODY(mt::TU32, dwPosition)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImQueryMemberInfoByGroupSnAndPosition_Rsp)							
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendCharState_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendCharState_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImCharState, TImCharState)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImCharState_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImCharState, TImCharState)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendSplash_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendSplash_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSplash, TImSplash)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImSendSplash_Ntf)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImSplash, TImSplash)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImConfig_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImConfig_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImCustomCfg, TImCustomCfg)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImConfigDataReady_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImScreenChatrom_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImScreenChatrom_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImScreenChatroom, TImScreenChatroom)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImGetScreenedChatroms_Req)
 	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImGetScreenedChatroms_Rsp)							
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImScreenChatromR_Req)
 	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImScreenChatromR_Rsp)					
	BODY(mt::TU32, emErrorID)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TImScreenChatroomR, TImScreenChatroomR)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMulitChatGetRosters_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, ChatID)
	BODY(mt::TRoomId, TRoomId)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImMulitChatGetRosters_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TU32, ChatID)
	BODY(mt::TRoomId, TRoomId)	
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetFriendConference_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNO, TImNO)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImGetFriendConference_Rsp)								
	BODY(mt::TU32, emErrorID)										// 成功时填写
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImInnerGroupChat_Ntf)
	BODY(mt::TU32, RoomHandler)									
	...
	* 发送方向：mtim -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImInnerChat_Ntf)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImTempSubscribe_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNO, TImNO)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImUnTempSubscribe_Req)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNO, TImNO)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImTempSubscribe_Rsp)							
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNO, TImNO)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImUnTempSubscribe_Rsp)							
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TImNO, TImNO)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImBatchAddContacts_Req)
 	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImBatchAddContacts_Rsp)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImBatchDelContacts_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImBatchDelContacts_Rsp)									
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TBatchDelContacts, TBatchDelContacts)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImBatchMoveContacts_Req)
 	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */
 	MESSAGE(Ev_MT_BLL_ImBatchMoveContacts_Rsp)								
 	BODY(mt::TU32, emErrorID)
 	BODY(mt::TU32, HANDLE)
 	BODY(mt::TBatchMoveContacts, TBatchMoveContacts)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImGetServerTime_Req)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtsdk -> mtim
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImGetServerTime_Rsp)
	BODY(mt::TU32, emErrorID)
	BODY(mt::TU32, time)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtrest -> mtim
	* ******************************************************************************** */
	MESSAGE(Ev_MT_BLL_ImQueryAccountInfo_Rsp)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImUserDisconnect_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	* 发送方向：mtim -> mtsdk
	* ******************************************************************************** */	
	MESSAGE(Ev_MT_BLL_ImConfigItemChange_Ntf)
	BODY(mt::TU32, HANDLE)
	...
	*    发送方向: mtsdk -> mtim
	************************************************************************************/
	MESSAGE(Ev_MT_BLL_ImGetOrganizationState_Req)
	BODY(mt::TU32, HANDLE)
	...
	*    发送方向: mtsdk -> UI
	**********************************************************************************/
	MESSAGE(Ev_MT_BLL_ImGetOrganizationState_Rsp)
	BODY(mt::TU32, error)
	BODY(mt::TU32, HANDLE)
	BODY(mt::TString, TString)
	...
	************************************************************************************/
	MESSAGE(Ev_MT_BLL_ImGetHoldPersistentRoom_Req)
	BODY(mt::TU32, HANDLE)
	...
	**********************************************************************************/
	MESSAGE(Ev_MT_BLL_ImGetHoldPersistentRoom_Rsp)
	BODY(mt::TU32, error)
	BODY(mt::TU32, HANDLE)

#if !defined(_MESSAGE_HELP_)
     EV_BLL_END(MTIM) = EVSEG_BLL_IM_END
};
#endif

#define Is_BLL_MtIm_Msg(m) ((m) >= EV_BLL_BGN(MTIM) && (m) <= EV_BLL_END(MTIM))

#endif  // _MTBLLIMMSG_H_