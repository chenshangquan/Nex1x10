...
#define     MCU_TYPE_KDV10000A	             10   //MCU类型KDV10000A
#define     MCU_TYPE_KDV10000A_PORT          11   //MCU类型KDV10000A_PORT
...
//画面合成类型定义
#define    VMP_TYPE_NONBROADCAST			    0	//非广播
#define    VMP_TYPE_BROADCAST					1	//广播
#define    VMP_TYPE_SELFRECEIVE					2	//自己看
...
//tianzhiyong 2010/03/27  将最大混音成员数由原来的APU下56改为EAPU下64， 现在需要改为192
...
private:    
	...
	// 该字段以位为单位使用
	// 取低(bit 1+bit 2)标识会议点名模式，点名时依照此信息开启点名
	u8				m_byConfEx2Info;				  //保留字段	
...
public:
    ...
    void Reset()
    {
		...
		SetRollCallMode(ROLLCALL_MODE_VMP); //默认合成点名模式
    }
	...
	//设置端口媒体会议标志位[4/10/2014 yanghuaizhi]
