...
#define AUDIF_TYPE_BUILTINMIC      	0x0f
...
#define AUDIF_BUILTINMIC(n)                   AUDIF_PHY(AUDIF_TYPE_BUILTINMIC,        n)
...
/* audio voice control param */
typedef struct
{
	u32 value;      /* voice control range value */
	u32 increase_or_not;      /* 1:yes   0:decrease */
	u8 mute_or_not;			/*1: not mute  0:mute*/
} TAudVoiceControl;
...
typedef struct {
    u32 dwupval;        /*upper limit (0x2b000000)*/
    u32 dwdownval;      /*lower limit (0x00000000)*/
} TAudIfThreshold;
...
enum eAudIfCmd {
	...
	AUDIF_SET_VOICE_CONTROL, /* pArgs = (TAudVoiceControl *) */
	AUDIF_SET_VOICE_CONTROL_PRE_MIX_AUDIO3, /*  pArgs = (TAudVoiceControl *) */
	AUDIF_SET_VOICE_CONTROL_PRE_MIX_AUDIO4, /*  pArgs = (TAudVoiceControl *) */
	AUDIF_SEL_MIX_SRC,		/* pArgs = (u32 *); src: AUDIF_HDMI(0).. */
	AUDIF_SET_INPUT_AUD_SAMPLERATE, /* pArgs = (u32 *); 8K 16K 32K 44.1K 48K*/
	AUDIF_DET_INPUT_AUDIO,
	AUDIF_SET_LIMIT_THRESHOLD
};
