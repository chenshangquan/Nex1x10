...
MODULE_DEF( MID_MCU_MPUAGENT,		MID_MCU_START + 9 );		// peqpmsg
...
MODULE_DEF( MID_MCU_INTERACT,       MID_MCU_START + 28 );       // pinteractmsg
...
MODULE_DEF( MID_MCU_DSMGR,      	MID_MCU_START + 49 );		// DSMgr模块
...
//mcu视频适配（xmm h264-h265互转）
MODULE_DEF( MID_XMM_XMM,		  MID_MCU_START + 200 );
MODULE_DEF( MID_XMM_DSMGR,        MID_MCU_START + 201 );
MODULE_DEF( MID_XMM_XMMCLIENT,    MID_MCU_START + 202 );
...
//接入模块[1240, 1259]
#define MID_ENTRANCE_START          (u16)(MID_MCSDK_START + 20)
...
//接入模块[1240, 1259]
MODULE_DEF (MID_ENTRANCE_CALLMANAGER,   MID_ENTRANCE_START + 0);      //1240
MODULE_DEF (MID_ENTRANCE_H323N,			MID_ENTRANCE_START + 1);      //1241
MODULE_DEF (MID_ENTRANCE_H323S,			MID_ENTRANCE_START + 2);      //1242
MODULE_DEF (MID_ENTRANCE_H323NADP,		MID_ENTRANCE_START + 3);      //1243
MODULE_DEF (MID_ENTRANCE_H323SADP,		MID_ENTRANCE_START + 4);      //1244
MODULE_DEF (MID_ENTRANCE_NGI,			MID_ENTRANCE_START + 5);      //1245
MODULE_DEF (MID_ENTRANCE_APS,			MID_ENTRANCE_START + 6);      //1246
MODULE_DEF (MID_ENTRANCE_SIPPROXY,		MID_ENTRANCE_START + 7);      //1247
MODULE_DEF (MID_ENTRANCE_SIPAGENT,		MID_ENTRANCE_START + 8);      //1248
MODULE_DEF (MID_ENTRANCE_PAS,			MID_ENTRANCE_START + 9);      //1249
#endif
//end of file
